...
namespace SpringHeroBank.entity
{
    public class Account
    {
        ...
        public Dictionary<string, string> CheckValid()
        {
            ...
            else if (this._fullName.Length < 3)
            {
                errors.Add("fullname", "Fullname is too short.");
            }
            ...
            else if (this._fullName.Length <8)
            {
                errors.Add("phone", "Phone is too short.");
            }
            
            if (string.IsNullOrEmpty(this._identityCard))
            {
                errors.Add("identitycard", "Identitycard can not be null or empty.");
            }
            else if (this._identityCard.Length <9)
            {
                errors.Add("identitycard", "Identitycard is too short.");
            }
